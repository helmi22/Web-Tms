...
<!-- End Loader -->
    ...
    <div class="header-section">
        <div class="row">
            <div class="col-md-5 col-sm-5">
                <div class="logo-img">
                    <a href="#"><img src="<?php echo base_url()?>assets/images/logo.jpg" class="img-responsive" alt=""></a>
                </div>
            </div>
            <div class="col-md-7 col-sm-7">
                <div class="top-info">
                    <ul class="top-social">
                        ...
                        <li><a href="<?php echo base_url()?>index.php/template/login" class="twitter"><i class="fa fa-lock"></i></a></li>
                        <li><a href="#" class="google-plus"><i class="fa fa-google-plus"></i></a></li>
                    </ul>
                    <div class="top-phone clearfix"><i class="fa fa-phone"></i>0857-7097-2671</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <?php $this->load->view('home/fitur');?>

    <?php $this->load->view('home/laman_depan');?>
